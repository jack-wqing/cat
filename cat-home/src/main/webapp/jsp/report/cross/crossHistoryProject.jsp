...
<table class='table table-striped table-condensed  '>
		...
		<tr><td colspan="7" style="text-align:center"><strong>调用其他服务的RPC接口</strong></td></tr>
		<tr>
		...
		<c:if test="${!empty model.projectInfo.serviceProjectsInfo}">
			<tr><td colspan="7" style="text-align:center"><strong>提供RPC接口供其他服务使用 [ 服务器端数据 ]</strong></td>
			<c:if test="${!empty model.projectInfo.callerProjectsInfo}">
				<td></td>
				<td colspan="7" style="text-align:center"><strong>提供RPC接口供其他服务使用 [ 客户端数据 ]</strong></td>
			</c:if>
			</tr>
		      <tr>
		         <th class="left">Type</th>
