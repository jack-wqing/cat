...
public class GraphPayload {
    ...
    final static class _999Payload extends AbstractPayload {
        public _999Payload(String title, String axisXLabel, String axisYLabel, TransactionName name) {
            super(title, axisXLabel, axisYLabel, name);
        }
        ...
        protected double[] loadValues() {
            ...
            for (Range range : getTransactionName().getRanges().values()) {
                double line9999Value = range.getLine9999Value();

                values[range.getValue()] += line9999Value;
            }
	...
	final static class _99Payload extends AbstractPayload {
		public _99Payload(String title, String axisXLabel, String axisYLabel, TransactionName name) {
			super(title, axisXLabel, axisYLabel, name);
		}
		...
		protected double[] loadValues() {
			...
			for (Range range : getTransactionName().getRanges().values()) {
				double line99Value = range.getLine99Value();

				values[range.getValue()] += line99Value;
			}
